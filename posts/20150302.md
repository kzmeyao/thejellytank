...
One problem I had to solve early on was to decide whether I should go with a static content generator or whip up something on my own. I've heard great things about Jekyll and how well it works with hosting on Github, but the creator in me wanted to take on a new challenge. Ultimately, I didn't need a full-featured system, I wanted to keep everything fairly minimal, and I was hell-bent on making it a single page application. Those choices led me to [Gulp](http://gulpjs.com/).