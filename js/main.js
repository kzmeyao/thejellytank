        ...
        <nav id="js-bloom">
          <div className="nav-overlay">
            <div className="nav-wrapper">
              <div className="nav-logo" ref="logo"></div>
              <h2><span className="nav-gradient">THEJELLYTANK</span></h2>
              <h3 className="thin"><Link to="write">write</Link> x <Link to="shoot">shoot</Link> x <Link to="greet">greet</Link></h3>
            </div>
          </div>
        </nav>
    ...
    return (
      <article className="segment">
        <section className="intro">
          ...
          <button>Guilty as Charged</button>
        </section>
      </article>
    );
  }
