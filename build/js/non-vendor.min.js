        ...
        React.createElement("nav", {id: "js-bloom"}, 
          React.createElement("div", {className: "nav-overlay"}, 
            React.createElement("div", {className: "nav-wrapper"}, 
              React.createElement("div", {className: "nav-logo", ref: "logo"}), 
              React.createElement("h2", null, React.createElement("span", {className: "nav-gradient"}, "THEJELLYTANK")), 
              React.createElement("h3", {className: "thin"}, React.createElement(Link, {to: "write"}, "write"), " x ", React.createElement(Link, {to: "shoot"}, "shoot"), " x ", React.createElement(Link, {to: "greet"}, "greet"))
            )
          )
        ), 
    ...
    return (
      React.createElement("article", {className: "segment"}, 
        React.createElement("section", {className: "intro"}, 
          ...
          React.createElement("button", null, "Guilty as Charged")
        )
      )
    );
  }
